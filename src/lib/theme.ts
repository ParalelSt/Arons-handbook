  ...
  blue: {
    ...
    colors: {
      ...
      button: {
        ...
        accent: 'bg-blue-600/20 border border-blue-500/50 hover:bg-blue-600/30 hover:border-blue-500',
      },
    },
  },
  red: {
    ...
    colors: {
      ...
      button: {
        ...
        secondary: 'bg-slate-700 hover:bg-slate-600 text-white',
        accent: 'bg-red-600/20 border border-red-500/50 hover:bg-red-600/30 hover:border-red-500',
      },
    },
  },
  slate: {
    ...
    colors: {
      ...
      button: {
        ...
        secondary: 'bg-slate-700 hover:bg-slate-600 text-white',
        accent: 'bg-slate-600/20 border border-slate-500/50 hover:bg-slate-600/30 hover:border-slate-500',
      },
    },
  },
};
