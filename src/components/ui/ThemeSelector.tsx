...
export function ThemeSelector() {
  ...
  return (
    <div className="relative">
      ...
      {showMenu && (
        <div className="absolute right-0 sm:right-0 top-full mt-2 bg-slate-800 border border-slate-700 rounded-lg shadow-lg p-3 w-[180px] z-50 -translate-x-0 sm:translate-x-0">
